      ...
      ">
        ...
        <div className="relative w-full sm:w-44 md:w-52 h-44 sm:h-40 md:h-44">
          ...
          <button className="group
            absolute bottom-2 right-2 font-medium
            flex items-center gap-1
            bg-gray-400 group-hover:bg-blue-600 group-hover:text-white
            text-black
            text-xs
            px-3 py-2.5
            rounded-md
          ...
          ">
            Shop Now
            <span className="text-sm"><svg className="w-4 h-4 text-slate-500 group-hover:text-white transition-colors duration-200"
